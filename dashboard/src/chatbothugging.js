...
// SQL Tool using Hugging Face and sql.js
...
const runnableAgent = RunnableSequence.from(tools);

// Example usage inside an async function
async function runExample() {
    // const input1="display sales dashboard of region east"
  const input1 = "Get the total sales amount by region for the year 2023";
